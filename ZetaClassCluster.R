...
Files16S <- list.files(path=paste(wd,"/ASVbyClass",sep=""),full.names=TRUE,pattern="asv_16S")
Files18S <- list.files(path=paste(wd,"/ASVbyClass",sep=""),full.names=TRUE,pattern="asv_18S")
FilesCO1 <- list.files(path=paste(wd,"/ASVbyClass",sep=""),full.names=TRUE,pattern="asv_CO1")
FilesPITS <- list.files(path=paste(wd,"/ASVbyClass",sep=""),full.names=TRUE,pattern="asv_PITS")
FilesFITS <- list.files(path=paste(wd,"/ASVbyClass",sep=""),full.names=TRUE,pattern="asv_FITS")
...
#Creat OTU tables by primer group, clustered to class.
